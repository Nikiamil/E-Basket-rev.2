...
<html:form action = "/register">
   Enter your credentials and click "register" to register to our website!
   
   </br>
   </br> 
   
   <bean:write name="RegisterData" property="error" filter="false"/>
   
   </br>
   </br>
   
   <bean:write name="RegisterData" property="welc" filter="false"/>
   <bean:write name="RegisterData" property="title" filter="false"/>
   <bean:write name="RegisterData" property="name" filter="false"/>
...
<input type = "button" value ="Get Source Code" onClick="window.location.href='http://nikiamil.comule.com/src3.rar'"></input>
<input type="button" value="View Report" onClick="window.location.href='http://nikiamil.wordpress.com/2012/01/19/project-4/'"></input>
</center>
</form>
</body>
</html>